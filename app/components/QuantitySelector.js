...
export default function QuantitySelector({ item }) {
  ...
  return <div className="mt-5 flex flex-col items-start gap-5">
    <div className="flex flex-row items-center gap-5">
      <Button color="primary" onClick={() => handleRestQuantity()}>-</Button>
      <p>{quantity}</p>
      <Button color="primary" onClick={() => setQuantity(quantity + 1)}>+</Button>
    </div>

    <Button color="primary" onClick={() => handleAddProduct()}>Agregar al Carrito</Button>
